            ...
            mSupportMapFragment.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap googleMap) {
                    if (googleMap != null) {
                        ...
                        googleMap.addMarker(new MarkerOptions().position(origin).title("Origin").snippet("Testeando"));
                        googleMap.addMarker(new MarkerOptions().position(dest).title("Dest").snippet("Testeando"));
